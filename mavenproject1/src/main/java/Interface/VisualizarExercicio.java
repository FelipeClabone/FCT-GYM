 ...
 */
public class VisualizarExercicio extends javax.swing.JFrame {

    Controlador controller =  new Controlador();
    /**
     * Creates new form VisualizarExercicio
     */
    public VisualizarExercicio() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Utils.hasNull(values)){
            ...
            String relatorio = controller.visualizarExercicios(email);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarExercicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizarExercicio().setVisible(true);
            }
        });
    }
